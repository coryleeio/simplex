...
int main() {
  ...
  Simplex::Shader vertexShader("../tests/6translation/shader.vert", GL_VERTEX_SHADER);
  Simplex::Shader fragmentShader("../tests/6translation/shader.frag", GL_FRAGMENT_SHADER);
